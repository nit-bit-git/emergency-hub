...
//struct for post
 ...
 mapping(uint256 => Disaster) public disasters;
  ...
  //  mapping(uint256 => Post) public posts;
    ...
    address[] public admin = [0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2,0xB9eF15e56A39fAc2a66431d88c7ef950652e6560,0x936F3348c3035ea5530F0d959272DC6cC0402C44,0x91f6C69e532F199c4Fde2fb5F23456D505a7DaD5];
...
function createDisaster( address _owner,
   ...
   function donateToDisaster(uint256 _id) public payable {
        ...
        (bool sent,) = payable(disaster.owner).call{value: amount}("");

        if(sent) {
            disaster.amountCollected = disaster.amountCollected + amount;
        }
    }
